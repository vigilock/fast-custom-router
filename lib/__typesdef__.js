...
/**
 * @augments {Router} Use Use middleware
 * @typedef RouterElementMiddleware
 * @property {Middleware[]} pre_middlewares
 * @property {Middleware[]} post_middlewares
 */
 ...
 * @property {Function | undefined} middleware
 */
 ...
 * @property {string[]} [pre_middlewares] List of middleware names, called before routes
 * @property {string[]} [post_middlewares] List of middleware names, called after routes
 * @property {number} [response_code=200] Response code that is returned on route call success, 200 by default. Default is `200`
...
/**
 * @typedef ControllerParameter
 * @property {object} body: This.__getBody(req),
 * @property {object} headers: Req.headers,
 * @property {object} params: This.__getParams(req),
 * @property {object} query: Req.query,
 * @property {object} status: SetStatus,
 * @property {...object} etc
 */
